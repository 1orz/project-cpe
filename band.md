...
| 频段 | 类型 | 频率范围 | 位掩码 | 用途说明 |
|------|------|----------|--------|----------|
| **B1** | FDD | 2100MHz | 1 | 全球通用，联通/电信 FDD |
| **B3** | FDD | 1800MHz | 4 | 全球主力频段，三大运营商 |
| **B5** | FDD | 850MHz | 16 | 北美/亚洲低频 |
| **B8** | FDD | 900MHz | 128 | 欧洲/亚洲低频，联通 |
| **B39** | TDD | 1900MHz | 64 | 中国移动 TDD |
| **B41** | TDD | 2500MHz | 256 | 三大运营商 TDD 主力 |
...
| 频段 | 类型 | 频率范围 | 位掩码 | 用途说明 |
|------|------|----------|--------|----------|
| **N1** | FDD | 2100MHz | 1 | 低频 FDD，覆盖广 |
| **N3** | FDD | 1800MHz | 4 | 欧洲/亚洲 5G FDD |
| **N28** | FDD | 700MHz | 512 | 广电 700M，室内覆盖 |
| **N41** | TDD | 2500MHz | 16 | 三大运营商共用 |
| **N77** | TDD | 3700MHz | 128 | 全球 C-Band |
| **N78** | TDD | 3500MHz | 256 | 联通/电信主力频段 |
| **N79** | TDD | 4500MHz | 512 | 移动主力频段 |
...
| 网络 | 主力频段 | 建议锁定 |
|------|----------|----------|
| 4G | B39, B41 | `AT+SPLBAND=1,0,320,0,0,0,0` |
| 5G | N41, N79 | `AT+SPLBAND=2,0,0,528,0` (528=512+16) |

### 中国联通

| 网络 | 主力频段 | 建议锁定 |
|------|----------|----------|
| 4G | B1, B3 | `AT+SPLBAND=1,0,0,0,0,5,0` |
| 5G | N41, N78 | `AT+SPLBAND=2,0,0,272,0` (272=256+16) |
...
这些频段覆盖了中国三大运营商（移动、联通、电信）的主要 4G/5G 网络，可以满足国内使用需求。
